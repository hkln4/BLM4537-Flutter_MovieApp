...
import 'package:movies_app/profile/presentation/views/profile_page.dart';
import 'package:movies_app/profile/presentation/views/login_page.dart';
import 'package:movies_app/profile/presentation/views/register_page.dart';
import 'package:movies_app/core/resources/app_routes.dart';
import 'package:movies_app/watchlist/presentation/views/watchlist_view.dart';
import 'package:movies_app/favorites/presentation/views/favorites_view.dart';
import 'package:movies_app/reviews/presentation/views/my_reviews_view.dart';
...
const String myReviewsPath = '/myReviews';
...
class AppRouter {
  ...
  static GoRouter router = GoRouter(
    ...
    routes: [
      ShellRoute(
        ...
        routes: [
          ...
          GoRoute(
            ...
            path: favoritesPath,
            pageBuilder: (context, state) =>
                const CupertinoPage(child: FavoritesView()),
          ),
          GoRoute(
            name: AppRoutes.myReviewsRoute,
            path: myReviewsPath,
            pageBuilder: (context, state) =>
                const CupertinoPage(child: MyReviewsView()),
          ),
          GoRoute(
      ...
      // Login & Register ayrı ShellRoute dışında
      GoRoute(
